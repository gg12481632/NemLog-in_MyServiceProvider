...
#$cert = New-SelfSignedCertificate -DnsName ssc_sp.anysoft.dk -CertStoreLocation cert:\LocalMachine\My -Type CodeSigningCert
#$pwd = ConvertTo-SecureString -String "test1234" -Force -AsPlainText
...
write-host "Installed serviceprovider ssl certificate $($serviceProviderSslcertificate.Thumbprint) in LocalMachine\My and LocalMachine\TrustedPeople. This ensures the certificate is trusted on your machine and browser"
