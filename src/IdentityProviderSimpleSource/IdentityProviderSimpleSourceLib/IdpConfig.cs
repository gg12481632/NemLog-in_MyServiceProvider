...
namespace IdentityProviderSimpleSourceLib
{
    public sealed class IdpConfig
    {
        ...
        private static Dictionary<string, AuthRequestSubset> _spMetadataDict = new Dictionary<string, AuthRequestSubset>();
        ...
        public AuthRequestSubset GetSPMetadataById(string spId)
        {
            AuthRequestSubset spMetadata;
